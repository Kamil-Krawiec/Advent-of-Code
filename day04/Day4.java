...
public class Day4 {
    ...
    public ArrayList<BingoTable> bingoTables;//A hashMap for Tables and boolean flag of change
    ...
    public void collectData(String path) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(path))) {
            ...
            while ((data = br.readLine()) != null) {
                ...
                if (!numbers.equals(""))
                    bingoTables.add(new BingoTable(numbers));
    ...
    private boolean checkForWinner(BingoTable bt) {
        return bt.check();
    }

    private int countTheWinner(int lastDrawn, BingoTable theWinner) {
